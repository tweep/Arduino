...
// debug note: the FastLED delay function conflicts with the IRLIb2 libary
...
void loop() {
 ...
 // send the 'leds' array out to the actual LED strip
  ...
  // debug note: the FastLED delay function conflicts with the IRLIb2 libary as it
  // maybe shares the same interrupt ? 
